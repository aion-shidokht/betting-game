...
export default function VoteBox({handleDialog, isOpen}) {
  ...
  const handleSubmit = event => {
    ...
    // console.log({selectedStatement, answer});
    sendVoteTransaction(answer);
    handleDialog(false);
    setAnswer("")
  };
  ...
  const sendVoteTransaction = async (answer) => {
    if(window.aionweb3) {
      let web3 = new Web3(
      ...
      console.log("Voting for " + statementId + " " + answer);
